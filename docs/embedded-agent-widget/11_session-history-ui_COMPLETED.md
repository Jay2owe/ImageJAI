...
- `src/main/java/uk/ac/ucl/imagej/ai/engine/SessionCodeJournal.java`
  (from stage 04) — especially the `addListener` contract and
  `Entry` shape
- `src/main/java/uk/ac/ucl/imagej/ai/ui/LeftRail.java` (from
  stages 07, 09, 10)
- `src/main/java/uk/ac/ucl/imagej/ai/ui/TcpHotline.java` (from
...
| Path                                                                     | Action | Reason                                             |
|--------------------------------------------------------------------------|--------|----------------------------------------------------|
| `src/main/java/uk/ac/ucl/imagej/ai/ui/SessionHistoryPanel.java`          | NEW    | Rail section, renderer, click handlers             |
| `src/main/java/uk/ac/ucl/imagej/ai/ui/LeftRail.java`                     | MODIFY | Mount the panel above Macro sets                   |
