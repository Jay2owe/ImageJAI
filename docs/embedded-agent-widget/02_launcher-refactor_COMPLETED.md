...
- `src/main/java/uk/ac/ucl/imagej/ai/ui/ChatPanel.java:905-952`
  (`showAgentLaunchMenu`, the only current caller)
- `src/main/java/uk/ac/ucl/imagej/ai/ImageJAIPlugin.java:40-135`
...
- New `ChatSurface` facade in `uk.ac.ucl.imagej.ai.ui` — the minimal
...
| `src/main/java/uk/ac/ucl/imagej/ai/engine/ExternalAgentSession.java`          | NEW    | Detached-session stub for external terminals    |
| `src/main/java/uk/ac/ucl/imagej/ai/engine/AgentLauncher.java`                 | MODIFY | Return `AgentSession`, accept `Mode`, hoist spec|
| `src/main/java/uk/ac/ucl/imagej/ai/ui/ChatSurface.java`                       | NEW    | Facade for `ConversationLoop` + TCP wiring      |
| `src/main/java/uk/ac/ucl/imagej/ai/ui/ChatPanel.java`                         | MODIFY | Implement `ChatSurface`; accept `AgentSession`  |
| `src/main/java/uk/ac/ucl/imagej/ai/ConversationLoop.java`                     | MODIFY | Depend on `ChatSurface`, not concrete panel     |
| `src/main/java/uk/ac/ucl/imagej/ai/ImageJAIPlugin.java`                       | MODIFY | Pass `ChatSurface` where `ChatPanel` was passed |
