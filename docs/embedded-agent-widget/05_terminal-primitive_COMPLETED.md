...
- `src/main/java/uk/ac/ucl/imagej/ai/engine/AgentSession.java`
...
| `src/main/java/uk/ac/ucl/imagej/ai/terminal/ImageJAITtyConnector.java`     | NEW    | pty4j ↔ JediTerm bridge                          |
| `src/main/java/uk/ac/ucl/imagej/ai/terminal/EmbeddedPty.java`              | NEW    | Widget + process composition                     |
| `src/main/java/uk/ac/ucl/imagej/ai/engine/EmbeddedAgentSession.java`       | NEW    | `AgentSession` over `EmbeddedPty`                |
| `src/main/java/uk/ac/ucl/imagej/ai/engine/AgentLauncher.java`              | MODIFY | Real implementation for `Mode.EMBEDDED`          |
| `src/main/java/uk/ac/ucl/imagej/ai/ImageJAIPlugin.java`                    | MODIFY | Register smoke-test menu + font loading          |
