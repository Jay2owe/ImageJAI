...
- `src/main/java/uk/ac/ucl/imagej/ai/engine/AgentLauncher.java:46-56`
...
| `src/main/java/uk/ac/ucl/imagej/ai/ui/LeftRail.java`              | MODIFY | Agent section with Commands + New agent chat   |
