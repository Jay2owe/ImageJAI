...
- `src/main/java/uk/ac/ucl/imagej/ai/config/Settings.java`
- `src/main/java/uk/ac/ucl/imagej/ai/ui/SettingsDialog.java`
  (especially `firstRunFlow()`)
- `src/main/java/uk/ac/ucl/imagej/ai/ui/ChatPanel.java:178-193`
  (the hard-disable logic)
- `src/main/java/uk/ac/ucl/imagej/ai/ImageJAIPlugin.java` (TCP
...
| Path                                                                  | Action | Reason                                               |
|-----------------------------------------------------------------------|--------|------------------------------------------------------|
| `src/main/java/uk/ac/ucl/imagej/ai/config/Settings.java`              | MODIFY | `agentEmbeddedTerminal`, `tcpPort`, migration hook   |
| `src/main/java/uk/ac/ucl/imagej/ai/ui/SettingsDialog.java`            | MODIFY | Surface flag + no-key first-run option               |
| `src/main/java/uk/ac/ucl/imagej/ai/ui/ChatPanel.java`                 | MODIFY | `updateInputState` honours local-only                |
| `src/main/java/uk/ac/ucl/imagej/ai/ImageJAIPlugin.java`               | MODIFY | Port-collision scan; write chosen port to Settings   |
