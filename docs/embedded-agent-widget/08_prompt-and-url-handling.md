...
- `src/main/java/uk/ac/ucl/imagej/ai/ui/TerminalView.java` (from
...
| Path                                                                        | Action | Reason                                         |
|-----------------------------------------------------------------------------|--------|------------------------------------------------|
| `src/main/java/uk/ac/ucl/imagej/ai/terminal/PromptWatcher.java`             | NEW    | 250 ms poll, pattern match, emit events        |
| `src/main/java/uk/ac/ucl/imagej/ai/terminal/ApprovalPolicy.java`            | NEW    | Loads approval.json, classifies prompts        |
| `src/main/java/uk/ac/ucl/imagej/ai/ui/TerminalToolbar.java`                 | NEW    | Confirm / Cancel / Interrupt / Kill / Copy URL |
| `src/main/java/uk/ac/ucl/imagej/ai/ui/TerminalView.java`                    | MODIFY | Mount toolbar above the JediTerm pane          |
| `src/main/java/uk/ac/ucl/imagej/ai/terminal/EmbeddedPty.java`               | MODIFY | Register hyperlink style + Ctrl+C override     |
