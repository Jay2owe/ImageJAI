...
| Path                                                              | Action | Reason                                       |
|-------------------------------------------------------------------|--------|----------------------------------------------|
| `src/main/java/uk/ac/ucl/imagej/ai/ui/LeftRail.java`              | NEW    | Container + header chevron + sections API    |
| `src/main/java/uk/ac/ucl/imagej/ai/ui/TcpHotline.java`            | NEW    | Short-lived socket JSON client               |
| `src/main/java/uk/ac/ucl/imagej/ai/ui/TerminalView.java`          | MODIFY | Swap WEST stub for the real `LeftRail`       |
