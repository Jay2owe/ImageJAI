...
- `src/main/java/uk/ac/ucl/imagej/ai/ui/ChatPanel.java:42-50`
  (colour constants: `BG_MAIN #1e1e23`, `ACCENT #00c8ff`, etc.
  — the JediTerm colour scheme must match)
- `src/main/java/uk/ac/ucl/imagej/ai/ui/AiRootPanel.java` (from
...
- **Log prefix consistency.** All new code from stages 05–11
  ...
  with `grep "IJ.log" src/main/java/uk/ac/ucl/imagej/ai/{terminal,ui}`
...
| Path                                                                  | Action | Reason                                             |
|-----------------------------------------------------------------------|--------|----------------------------------------------------|
| `src/main/java/uk/ac/ucl/imagej/ai/ui/TerminalHost.java`              | MODIFY | Font-size shortcuts + colour palette               |
| `src/main/java/uk/ac/ucl/imagej/ai/ui/AiRootPanel.java`               | MODIFY | Per-mode window-size memory                        |
| `src/main/java/uk/ac/ucl/imagej/ai/config/Settings.java`              | MODIFY | `persistScrollback` opt-in flag                    |
| `src/main/java/uk/ac/ucl/imagej/ai/ui/SettingsDialog.java`            | MODIFY | Expose `persistScrollback` checkbox                |
| `src/main/java/uk/ac/ucl/imagej/ai/engine/EmbeddedAgentSession.java`  | MODIFY | On destroy: serialise scrollback if enabled        |
