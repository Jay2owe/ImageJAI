...
| Path                                                                     | Action | Reason                                       |
|--------------------------------------------------------------------------|--------|----------------------------------------------|
| `src/main/java/uk/ac/ucl/imagej/ai/engine/SessionCodeJournal.java`       | NEW    | Singleton, ring, disk writes, listeners      |
| `src/main/java/uk/ac/ucl/imagej/ai/engine/CodeAutoNamer.java`            | NEW    | Cascading naming strategies                  |
| `src/main/java/uk/ac/ucl/imagej/ai/engine/TCPCommandServer.java`         | MODIFY | Two `record(...)` call sites, nothing else   |
