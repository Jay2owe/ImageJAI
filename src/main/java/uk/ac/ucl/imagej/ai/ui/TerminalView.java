...
import uk.ac.ucl.imagej.ai.engine.EmbeddedAgentSession;
import uk.ac.ucl.imagej.ai.config.Settings;
import uk.ac.ucl.imagej.ai.terminal.ApprovalPolicy;
import uk.ac.ucl.imagej.ai.terminal.PromptWatcher;
