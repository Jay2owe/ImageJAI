...
import uk.ac.ucl.imagej.ai.engine.IntentRouter;
import uk.ac.ucl.imagej.ai.local.slash.ClearSlashCommand;
import uk.ac.ucl.imagej.ai.local.slash.CloseSlashCommand;
import uk.ac.ucl.imagej.ai.local.slash.ForgetSlashCommand;
import uk.ac.ucl.imagej.ai.local.slash.HelpSlashCommand;
import uk.ac.ucl.imagej.ai.local.slash.InfoSlashCommand;
import uk.ac.ucl.imagej.ai.local.slash.IntentsSlashCommand;
import uk.ac.ucl.imagej.ai.local.slash.MacrosSlashCommand;
import uk.ac.ucl.imagej.ai.local.slash.TeachSlashCommand;
